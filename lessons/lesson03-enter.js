...
const enterReg = document.getElementById('enter');
...
enterReg.addEventListener('click', () => {
    console.log(getRegistration());
    console.log(usrReg.value);
    console.log(pasReg.value);
    if (checkRegistration()) {
        window.location.href = './index03-welcome.html';
    }
});
